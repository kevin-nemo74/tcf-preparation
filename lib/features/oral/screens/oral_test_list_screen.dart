    ...
    child: Row(
      children: [
        Container(
          ...
          child: Icon(Icons.headphones_rounded, color: cs.secondary, size: 28),
        ),
          ...
          children: [
            Container(
              ...
              decoration: BoxDecoration(
                ...
                border: Border.all(
                  color: cs.secondary.withValues(alpha: isSelected ? 0.4 : 0.2),
                ),
              ),
              child: Text(
                leading,
              ...
              child: Column(
                ...
                children: [
                  ...
                  Container(
                    ...
                    child: Row(
                      children: [
                        Icon(Icons.quiz_rounded, size: 16, color: cs.secondary),
